...
def main() -> None:
    ...
    # Determine if using Kimi model
    is_kimi = "kimi" in args.model.lower() or "moonshot" in args.model.lower()

    # Check for API key
    if is_kimi:
        if not os.environ.get("MOONSHOT_API_KEY"):
            print("Error: MOONSHOT_API_KEY environment variable not set")
            print("Please set it: export MOONSHOT_API_KEY='your-api-key-here'")
            return
    else:
